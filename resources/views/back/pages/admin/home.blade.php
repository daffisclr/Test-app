    ...
    <div class="pd-20 card-box mb-30">
        ...
        <form>
            ...
            <table class="table table-striped table-responsive">
                <tbody><tr><td colspan="4"><b>Survey Kepuasan Pengguna Lulusan Jurusan Teknik Informatika dan Komputer Politeknik
                    Negeri Jakarta
                    <script>
                        document.write(new Date().getFullYear());
                    </script></b></td></tr>
                <tr id="q1">
                    ...
                    <td>
                        <input type="radio" id="q1sangatbaik" name="q1" value="Sangat Baik" required="harus diisi">
                ...
                <tr id="q2">
                    <td valign="top">Bagaimana <b>keahlian</b> lulusan kami yang bekerja di tempat Anda berdasarkan bidang ilmunya?</td>
                    <td valign="top" style="width:5px;">:</td>
                    <td>
                        <input type="radio" id="q2sangatbaik" name="q2" value="Sangat Baik" required="harus diisi">
                ...
                <tr id="q3">
                    <td valign="top">Bagaimana kemampuan <b>berbahasa asing</b> lulusan kami yang bekerja di tempat Anda?</td>
                    <td valign="top" style="width:5px;">:</td>
                    <td>
                        <input type="radio" id="q3sangatbaik" name="q3" value="Sangat Baik" required="harus diisi">
                ...
                <tr id="q4">
                    <td valign="top">Bagaimana kemampuan <b>penggunaan teknologi informasi</b> lulusan kami yang bekerja di tempat Anda?</td>
                    <td valign="top" style="width:5px;">:</td>
                    <td>
                        <input type="radio" id="q4sangatbaik" name="q4" value="Sangat Baik" required="harus diisi">
                ...
                <tr id="q5">
                    <td valign="top">Bagaimana kemampuan <b>berkomunikasi</b> lulusan kami yang bekerja di tempat Anda?</td>
                    <td valign="top" style="width:5px;">:</td>
                    <td>
                        <input type="radio" id="q5sangatbaik" name="q5" value="Sangat Baik" required="harus diisi">
                ...
                <tr id="q6">
                    <td valign="top">Bagaimana kemampuan <b>kerjasama</b> lulusan kami yang bekerja di tempat Anda?</td>
                    <td valign="top" style="width:5px;">:</td>
                    <td>
                        <input type="radio" id="q6sangatbaik" name="q6" value="Sangat Baik" required="harus diisi">
                ...
                <tr id="q7">
                    <td valign="top">Bagaimana kemampuan <b>pengembangan diri</b> lulusan kami yang bekerja di tempat Anda?</td>
                    <td valign="top" style="width:5px;">:</td>
                    <td>
                        <input type="radio" id="q7sangatbaik" name="q7" value="Sangat Baik" required="harus diisi">
                ...
                <tr id="q10">
                    <td valign="top">Bagaimana <b>kesiapan terjun di masyarakat</b> lulusan kami yang bekerja di tempat Anda?</td>
                    <td valign="top" style="width:5px;">:</td>
                    <td>
                        <input type="radio" id="q10sangatbaik" name="q10" value="Sangat Baik" required="harus diisi">
                ...
                <tr id="q8" class="tr-quis">
                    <td valign="top">Bagaimana harapan Anda terhadap lulusan Jurusan Teknik Informatika dan Komputer Politeknik
                        Negeri Jakarta?
                    </td><td valign="top">:</td>
                    <td>

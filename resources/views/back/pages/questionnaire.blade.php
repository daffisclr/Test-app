                ...
                <div class="tab-wizard1 wizard-circle wizard">
                    ...
                    <section>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>f5-02/06 - Berapa bulan Anda mendapatkan pekerjaan pertama setelah lulus atau
                                        Waktu
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>f5-05 - Berapa pendapatan Anda per bulan pada saat Anda mendapatkan pekerjaan
                                        pertama
                                        (take home pay)?</label>
                                    <input type="number" class="form-control" />
                                </div>
                            ...
                            <div class="col-md-12">
                                <label> F5c - Bila berwiraswasta, apa posisi/ jabatan Anda saat ini? <b>(Apabila F8 menjawab
                                        [3]
                                        wiraswasta)</b> </label>
                                <div class="form-group">
                                    <select class="custom-select form-control">
                            ...
                            <div class="col-md-12">
                                <label>Pertanyaan studi lanjut <b>(Apabila F8 menjawab [4] Melanjutkan
                                        Pendidikan)</b></label>
                                <br>
                            ...
                            <div class="col-md-12">
                                <label> F17a - Pada saat lulus, pada tingkat mana kompetensi di bawah ini anda
                                    kuasai?</label>
                                <br>
                                <p>Skor 1-5 (1 sangat rendah - 5 sangat tinggi)</p>
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-2 col-form-label">Etika</label>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-2 col-form-label">Keahlian berdasarkan bidang
                                        ilmu</label>
                                    <div class="col-sm-12 col-md-10">
                                        <input type="radio" />
                                        <label for="contactChoice1">1</label>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-2 col-form-label">Bahasa Inggris</label>
                                    <div class="col-sm-12 col-md-10">
                                        <input type="radio" />
                                        <label for="contactChoice1">1</label>
                                        <input type="radio" />
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-2 col-form-label">Penggunaan Teknologi Informasi</label>
                                    <div class="col-sm-12 col-md-10">
                                        <input type="radio" />
                                        <label for="contactChoice1">1</label>
                                        <input type="radio" />
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-2 col-form-label">Kerjasama</label>
                                    <div class="col-sm-12 col-md-10">
                                        <input type="radio" />
                                        <label for="contactChoice1">1</label>
                                        <input type="radio" />
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-2 col-form-label">Pengembangan diri</label>
                                    <div class="col-sm-12 col-md-10">
                                        <input type="radio" />
                                        <label for="contactChoice1">1</label>
                                        <input type="radio" />
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div style="margin-left: 32px" class="col-md-6 col-sm-12">
                                            ...
                                            <div class="custom-control custom-radio mb-3">
                                                <input type="radio" id="3" name="customRadio" class="custom-control-input">
                                                <label class="custom-control-label" for="3">Cukup besar</label>
                                            </div>
                                            <div class="custom-control custom-radio mb-3">
                                                <input type="radio" id="4" name="customRadio" class="custom-control-input">
                                                <label class="custom-control-label" for="4">Kurang</label>
                                            </div>
                                            <div class="custom-control custom-radio mb-3">
                                                <input type="radio" id="5" name="customRadio" class="custom-control-input">
                                                <label class="custom-control-label" for="5">tidak sama sekali</label>
                                            </div>
                                        </div>
                                        <div style="margin-left: 32px" class="col-md-6 col-sm-12">
